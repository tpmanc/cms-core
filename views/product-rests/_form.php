...
<div class="product-rests-form">
    ...
    <div class="form-group">
        <?= Html::submitButton($model->isNewRecord ? Yii::t('core/productRests', 'Create') : Yii::t('core/productRests', 'Update'), ['class' => $model->isNewRecord ? 'btn btn-success' : 'btn btn-primary']) ?>
    </div>
